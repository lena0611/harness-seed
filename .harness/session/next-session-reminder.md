...
- 현재 본체 버전: **0.2.97** — 의존성 미설치 진단(node_modules 부재 시 원인 불명 도구 에러 대신 "npm install 후 harness:check" 명확 안내, 온보딩 실측 2회 반영). 레지스트리 동반 범프: 스택 v0.2.4·템플릿 v0.2.3(base v0.2.97 추종). 회귀 94종.
