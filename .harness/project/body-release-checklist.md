...
## 언제 내보내나 — 주 1회가 기본 (2026-09-11 사용자 결정)

**정기 릴리스는 주 1회입니다.** 고침이 끝났다고 바로 내보내지 않습니다. 커밋해서 `CHANGELOG.md`의 `미배포` 절에 쌓아 두고, 정기 릴리스 때 한 번에 냅니다.

**즉시 내보내는 것은 셋뿐입니다.**

| 핫픽스 조건 | 뜻 |
| --- | --- |
| 막힘 | 소비자가 하던 일을 못 하게 됐다 |
| 조용한 위험 | 잘못된 결과가 나는데 아무도 모른다 |
| 거짓 안내 | 하네스가 사실이 아닌 것을 말하고 있다 |

셋 중 어디에도 안 들어가면 쌓습니다. "고쳤으니 내보내자"는 이유가 되지 않습니다.

- 릴리스 착수는 **사용자가 명시적으로 말할 때만** 합니다. 에이전트가 먼저 꺼내지 않습니다 — 쌓아 두는 것이 정상 상태입니다.
- 옛 배치 기준("2주 또는 개선 5건")은 폐기했습니다. 날짜나 개수가 아니라 **주 1회 + 핫픽스 셋**입니다.
- 쌓는 자리와 쓰는 법은 3단계를 보세요.
