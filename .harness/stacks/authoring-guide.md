...
| 특정 프레임워크와 런타임 조합에서 반복되는 기술 구조, 명령, 검증 기준 | 스택 하네스 |
...
제품 유형별 계약이나 scaffold가 필요하면 스택 하네스에 억지로 넣지 말고 `ai-standard/stacks` 하위 템플릿 저장소로 분리합니다. 스택 하네스는 기술 기준을 맡고, 템플릿은 제품 계약과 초기 파일 생성을 맡습니다.
