 ...
 *    documentation/style-harness, stacks)만 복사. workflows/ ISSUE_TEMPLATE/
 *    pull_request_template.md / commit-template.txt 는 프로젝트마다 다르므로
 *    제외.
 *  - scripts/*.mjs (apply-stack, guard, policy-harness, doc-link-check,
 *    install-hooks, check-seed-mode) 복사. init.mjs 자체는 제외.
 *  - .githooks/ 복사.
