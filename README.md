...
- **시드 모드(seed mode)**: `.harness-seed-mode` 파일이 있으면 활성. bareunmal 본 저장소에서만 사용. 일반 사용자는 첫 사용 시 삭제.
...
### B) 시드 하네스로 계속 운영하는 경우 (bareunmal 본 저장소)
...
`main` 푸시 시 GitHub Actions가 빌드 후 GitHub Pages로 배포합니다.
